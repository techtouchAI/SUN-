  ...
  Future<void> exportDashboardToPdf(
    ...
    final dto = FinalCalculationDto(
      ...
      settings: SystemSettingsModel(
        ...
        panelIsc: SolarCalculationRepository.getInterpolatedIsc(panelCapacity),
        systemMode: systemMode,
        systemVoltage: result.systemVoltage,
        iqdExchangeRate: iqdExchangeRate,
        gridSchedule: GridScheduleModel(
          gridChargeDependencyPercent: result.gridContributionPercent,
        ),
      ),
      result: result,
    );
    return exportCalculationReport(dto);
  }
