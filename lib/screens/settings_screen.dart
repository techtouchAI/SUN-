...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  Widget _buildPriceInput({
    ...
    return ExplainedField(
      explanation: explanation ?? _placeholderExplanation(label),
  ...
  /// Fallback used only for fields that deliberately ship without a
  /// dedicated explanation, so the rendered UI stays consistent.
  FieldExplanation _placeholderExplanation(String label) {
    return FieldExplanation(
      title: 'شرح الحقل: $label',
      points: ['اترك القيمة الافتراضية إذا لم تكن متأكداً من المطلوب.'],
    );
  }
}
