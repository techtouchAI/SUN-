...
remaining_battery_pv_Wh    = max(0, required_battery_charge_Wh − requested_grid_charge_Wh)
...
`charger_power_W` هو قدرة الإنفرتر المطلوبة (ذروة الحمل مع هامش الأمان)، لأن الشاحن مدمج في الإنفرتر؛ فهو سقف ما يمكن تسليمه للبطارية فعلياً خلال ساعات توفر الوطنية. عند 100% اعتماد على الوطنية يصبح `remaining_battery_pv_Wh = 0` و`ألواح لشحن البطاريات = 0`. إذا كانت قدرة الشاحن أو ساعات التوفر لا تكفي لتغطية النسبة المطلوبة يظهر تحذير صريح بعجز الشحن دون إضافة ألواح تلقائياً. يجب زيادة ساعات التوفر أو قدرة الشاحن أو خفض النسبة قبل التنفيذ. `gridContributionPercent` المعروضة هي النسبة **المخططة** لحساب ألواح الشحن، أما `grid_charge_energy_Wh` فتبقى محدودة بقدرة الشاحن وساعات التوفر لحساب تيارات الشحن والإنتاج الساعي.
